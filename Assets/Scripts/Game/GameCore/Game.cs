...
namespace GameCore { 
    public class Game
    {
        ...
        public void AttackUnit(Vector2Int attackerPos, Vector2Int defenderPos)
        {
        ...
        public bool TryBuyUnit(Type unitType, City selectedCity)
        {
            return selectedCity.AddUnitToTrainQuene(unitType);
        }

        public void RemoveUnitFromSpawnQuene(Type unitType, City selectedCity)
        {
